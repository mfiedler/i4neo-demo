...
\begin{frame}[fragile]{Presentation notes}
  The theme has built-in support for pdfpc notes

  \begin{verbatim}    \pnote{Important presentation note}\end{verbatim}

  go and test it in \texttt{pdfpc}!
  \pnote{Hi there!}
\end{frame}
...
\begin{frame}{References}
  ...
  References can also be added in place as footnote\footnote{Just use a normal footnote which contains lots and lots of text and can be created using \\footnote\{\}}
\end{frame}
